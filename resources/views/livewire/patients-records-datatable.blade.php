<div class="flex space-x-1 justify-around ">
    ...
    <a href="{{ route('staff.patients.edit', [$id]) }}"  class="p-1 text-blue-600 hover:bg-blue-600 hover:text-white rounded has-tooltip">
        <span class='tooltip rounded shadow-lg p-1 bg-gray-100 text-green-500 -mt-8'>Edit Patient Details</span>
